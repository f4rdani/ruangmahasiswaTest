<!DOCTYPE html>
<html lang="en" dir="ltr" data-nav-layout="vertical" data-theme-mode="light" data-header-styles="light" data-menu-styles="gradient" data-toggled="close" style="--primary-rgb: 80, 198, 118;">
...
<head>
    ...
    <title> Ruang Mahasiswa Universitas Bina Sarana Informatika </title>
                ...
                <div class="header-content-right">
                    ...
                    <div class="header-element headerProfile-dropdown">
                        ...
                        <a href="javascript:void(0);" class="header-link dropdown-toggle" id="mainHeaderProfile" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
                            <img src="<?= base_url()?>/assets/images/faces/6.jpg" alt="img" width="37" height="37" class="rounded-circle">
                        </a>
                        ...
                        <ul class="main-header-dropdown dropdown-menu pt-0 header-profile-dropdown dropdown-menu-end main-profile-menu" aria-labelledby="mainHeaderProfile">
                            <li>
                                <div class="main-header-profile bg-success menu-header-content text-fixed-white">
                                    <div class="my-auto">
                                        <h6 class="mb-0 lh-1 text-fixed-white"><?= $this->session->name?></h6>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li><a class="dropdown-item d-flex" href="<?=  base_url('Auth/logoutmhs');?>"><i class="bx bx-log-out fs-18 me-2 op-7"></i>Sign Out</a></li>
                            <?php endif; ?>
                        </ul>
                    </div>  
                    <!-- End::header-element -->
