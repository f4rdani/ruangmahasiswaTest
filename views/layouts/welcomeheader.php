                    ...
                    <div class="header-element">
                        <div class="horizontal-logo"  >
                            <a href="<?php echo base_url('Welcome');?>" class="header-logo" style="width:1500px;">
                                <img src="<?= base_url("assets");?>/images/bsi1.png" alt="logo" class="desktop-logo">
                                <img src="<?= base_url("assets");?>/images/bsi1.png" alt="logo" class="toggle-logo"  >
                                <img src="<?= base_url("assets");?>/images/bsi1.png" alt="logo" class="desktop-white"  >
                                <img src="<?= base_url("assets");?>/images/bsi1.png" alt="logo" class="toggle-white"  >
                            </a>
                        </div>
                    </div>
                    <!-- End::header-element -->
