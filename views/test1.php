...
<body>
    ...
    <div style="width: 100%; max-width: 800px; margin: 0 auto; border: 1px solid rgba(1, 1, 1, 0.3); border-radius: 8px; padding: 20px; text-align: center;">
        <div class="form-group" style="display: flex; justify-content: space-around; align-items: center;">
            <div style="flex: 1; margin: 10px;">
                <label for="nim" style="display: block; margin-bottom: 5px; color: black;">NIM</label>
                <input type="text" class="form-control" id="nim" name="nim" style="padding: 10px; border: 1px solid #ccc; border-radius: 4px;">
            </div>
            <div style="flex: 1; margin: 10px;">
            <label for="pilih" style="display: block; margin-bottom: 5px; color: black;">Pilih:</label>
        ...
        <button type="submit" class="btn btn-primary-gradient rounded-pill btn-wave" style="width: 200px; padding: 10px; border: none; border-radius: 4px; margin-top: 20px; cursor: pointer; background-color: #007bff; color: white;">Cetak Surat</button>
    </div>
</form>
