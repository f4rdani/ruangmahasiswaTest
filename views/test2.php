                                ...
                                <div class="accordion" id="accordionExample">
                                    ...
                                    <?= $this->session->flashdata('message'); ?>
                                        <form id="mainForm" method="post" action="<?=  base_url('#');?>">
                                            ...
                                            <button type="submit" class="btn btn-primary-gradient rounded-pill btn-wave" style="width: 100%; padding: 10px; border: none; border-radius: 4px; margin-top: 10px; cursor: pointer; background-color: #007bff; color: white;">Daftar Aktivasi</button>
                                        </form>
                                ...
                                <div class="accordion" id="accordionExample">
                                    ...
                                    <?= $this->session->flashdata('message'); ?>
                                        <form id="mainForm" method="post" action="<?=  base_url('#');?>">
                                            ...
                                            <button type="submit" class="btn btn-primary-gradient rounded-pill btn-wave" style="width: 100%; padding: 10px; border: none; border-radius: 4px; margin-top: 10px; cursor: pointer; background-color: #007bff; color: white;"> Aktivasi</button>
                                        </form>
